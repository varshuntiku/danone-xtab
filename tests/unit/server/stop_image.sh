...
export POSTGRES_URI="postgresql://db_user:p@ssw0rd@codex-test-system-db-service:5432/codex_test"
export POSTGRES_SERVICE_NAME="codex-test-system-db-service"
export POSTGRES_SERVICE_PORT="5432"
export DATA_FOLDER_PATH="/data"
export APP_FOLDER_PATH="/api"
export BACKEND_APP_URI="http://localhost:5002/codex-api"
