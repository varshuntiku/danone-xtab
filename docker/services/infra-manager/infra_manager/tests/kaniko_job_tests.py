...
if __name__ == "__main__":
    ...
    volumes_spec = [
        ...
        },
        {
            ...
            "secret": {
                ...
                "secret_key_paths": [
                    {
                        "key": os.environ.get("KANIKO_SECRET_KEY_NAME"),
                        "path": "config.json",
                    }
                ],
            },
    ...
    args = [
        ...
        f"--destination={os.environ.get('ACR_URL')}/execserv:v5",
    ]
    ...
    # Get Job Status
    job_status = job_manager.get_job_status(job_name=job_name, namespace="app-deployment")
