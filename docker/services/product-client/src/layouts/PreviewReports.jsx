...
class PreviewStories extends Component {
    constructor(props) {
        super(props);
        this.props = props;
        this.state = {
    ...
    componentDidMount() {
        ...
        getStory({
            story_id: storyId,
            callback: this.onResponseGetReport
        });
    }

    onResponseGetReport = (response_data) => {
        this.setState({
    ...
    download = () => {
        ...
        clonedElement.children[2].children[0].removeChild(
            clonedElement.getElementsByTagName('header')[0]
        );
                                    ...
                                    <div className={classes.overview}>
                                        <Grid container spacing={8}>
                                            <Grid item xs={6}>
                                                ...
                                                <p className={classes.description}>
                                                    This report focused on the cost benefit study
                                                    about the limited edition accessories and the
                                        ...
                                        <Grid container spacing={6}>
                                            <Grid item xs={6}>
                                                <p className={classes.description}>
                                                    <span className={classes.percentage}>
                                                        26%{' '}
                                                        <span className={classes.entity}> Tv</span>{' '}
                                                        <span className={classes.repute}>
                                                            Lead On
                                                        </span>
                                                    </span>
                                                    Lorem Ipsum is simply dummy text of the printing
