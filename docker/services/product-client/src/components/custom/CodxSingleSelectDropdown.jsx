...
export default function SingleSelectDropdown({ elementProps, onChange }) {
    const [value, setValue] = useState(
        elementProps.defaultValue ? elementProps.defaultValue : null
    );
    ...
    return (
        <ThemeProvider theme={selectCompTheme}>
            <Box width={elementProps?.width} margin={elementProps?.margin}>
                <InputLabel id={elementProps.label + '-label'}>{elementProps.label}</InputLabel>
                <Select
                    labelId={elementProps.label + '-label'}
                    id={elementProps.label + '-select'}
                    variant="outlined"
                    value={value}
                    onChange={(e) => {
                        setValue(e.target.value);
                        onChange(elementProps.id, e.target.value);
                    }}
                    MenuProps={MenuProps}
                    fullWidth
