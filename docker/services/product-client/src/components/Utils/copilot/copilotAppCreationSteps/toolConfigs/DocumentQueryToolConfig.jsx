...
export default function DocumentQueryToolConfig({
    toolData,
    appDatasources,
    llmModels,
    embeddingModels,
            ...
            <div className={classes.toolConfigContainer}>
                ...
                <div className={classes.dataSourceSection}>
                    <div>
                        ...
                        >
                            Select Data Source{requiredField}
                        </InputLabel>
                        <FormControl
                            size="small"
                            variant="outlined"
                        ...
                        >
                            ...
                            >
                                {appDatasources
                                    .filter(
                                        (el) => el.type === 'upload' || el.type === 'file_storage'
                                    )
                                    ?.map((el) => (
...
// DocumentQueryToolConfig.propTypes = {
