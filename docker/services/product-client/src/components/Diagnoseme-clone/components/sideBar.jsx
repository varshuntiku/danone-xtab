...
import LandingPageClone from '../landingPage';
        ...
        routes: [
            {
                ...
                selected: false,
                original_href: '/diagnoseme-clone/landingpage',
                href: '/diagnoseme-clone/diagnosis',
                show: true,
                show_title: true,
                expanded: false,
                level: 0,
            ...
            },
            {
                ...
                selected: false,
                original_href: '/diagnoseme-clone/uploadReports',
                href: '/diagnoseme-clone/uploadReports',
                show: true,
                show_title: true,
                expanded: false,
                level: 0,
            ...
            },
            {
                ...
                selected: false,
                original_href: '/diagnoseme-clone/Followup',
                href: '/diagnoseme-clone/Followup',
                show: true,
                show_title: true,
                expanded: false,
                level: 0,
                ...
                <div className={classes.wrapper}>
                    ...
                    <div id="bodyContent" className={classes.bodyContent}>
                        <Switch>
                            <Route
                                exact
                                path="/diagnoseme-clone/diagnosis"
                                render={() => <LandingPageClone />}
                            />
                            <Route
                                exact
                                path="/diagnoseme-clone/landingpage"
                                render={() => <LandingPageClone />}
                            />
                            <Route
                                exact
                                path="/diagnoseme-clone/uploadReports"
                                render={() => <UploadReports />}
                            />
                            <Route
                                exact
                                path="/diagnoseme-clone/followup"
                                render={() => <Followup />}
                            />
                            <Route
                                exact
