...
export default function ConfirmPopup({
    ...
    const [cautionCheckPassed, setCautionCheckPassed] = useState(!cautionCheck);
    ...
    const hanleCautionCheckValueChange = useCallback(
        (v) => {
            setCautionCheckPassed(v?.toLowerCase() === cautionCheck?.textToMatch?.toLowerCase());
        },
        [cautionCheck]
    );
            ...
            {disabled ? null : (
                ...
                >
                    ...
                    <DialogContent id="popup-content" className={classes.dailogContent}>
                        ...
                        {cautionCheck?.textToMatch ? (
                            <TextInput
                                fieldInfo={{
                                    label: cautionCheck.prompt,
                                    fullWidth: true,
                                    autoFocus: true
                                }}
                                onChange={hanleCautionCheckValueChange}
                                onPaste={(e) => {
                                    e.preventDefault();
                                    return false;
                                }}
                    ...
                    <DialogActions className={classes.actionsContainer}>
                        ...
                        {hideConfirmButton ? null : (
                            <Button
                                className={classes.btn}
                                disabled={cautionCheck ? !cautionCheckPassed : false}
                                variant="contained"
                                size="small"
