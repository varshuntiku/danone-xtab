...
export async function getSymptomsList() {
    try {
        const response = await axios.get(`https://diagnoseme.azurewebsites.net/get_symptoms`, {
            params: {},
            headers: {
...
export async function getSymptomQuestionsList(inputData) {
    try {
        const response = await axios.post(
            `https://diagnoseme.azurewebsites.net/get_symptoms_quest`,
            {
...
export async function getHistoryQuestionsList() {
    try {
        const response = await axios.get(`https://diagnoseme.azurewebsites.net/get_other_quest`, {
            headers: {
                'Content-Type': 'application/json'
            }
        });
...
export async function getPredictionResult(inputData) {
    try {
        const response = await axios.post(
            `https://diagnoseme.azurewebsites.net/get_disease_predictions`,
            {
                data: inputData
            },
            {
