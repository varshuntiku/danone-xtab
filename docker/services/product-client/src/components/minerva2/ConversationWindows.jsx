...
const useStyles = makeStyles((theme) => ({
    ...
    searchInput: {
        ...
        background: theme.props.mode === 'light' ? '' : alpha(theme.palette.primary.light, 0.5),
        borderBottom: theme.props.mode === 'light' ? '1px solid #d3ccda' : '',
        borderRadius: theme.props.mode === 'light' ? '0' : theme.spacing(1 / 2),
        '& .MuiInputBase-root': {
            fontSize: '1.6rem',
            fontWeight: '300',
    ...
    chatWindowItem: {
        ...
        '&:hover': {
            background: theme.props.mode === 'light' ? '' : theme.palette.background.hover,
            opacity: '1',
            '& $starIcon': {
                visibility: 'visible'
            },
    ...
    chatWindowItemSeclted: {
        background:
            theme.props.mode === 'light' ? '#e9f2fb' : theme.palette.primary.light + ' !important',
        opacity: 1,
        '& $chatIcon': {
...
export default function ConversationWindows({ minervaAppId, handleSelectedChat, totalQueries }) {
