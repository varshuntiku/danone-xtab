...
import { setTreeviewNodeIds, setCollapseBrowseBpFilePreview, setShowPreview } from 'store';
import { getPathFromNode } from './utils';
import PreviewComponent from '../PreviewFiles';
...
export default function BrowseBlueprintVisualGraph({ classes }) {
    ...
    const { treeviewNodes, fileShare, filePrefix, collapse_browse_bp_file_preview, showPreview } =
            ...
            {showPreview ? (
                <>
                    ...
                    <Grid item xs className={clsx(classes.browseBpReactFlowContainer)}>
                        <IconButton
                            onClick={() => onClickCollapseScreens(!collapse_browse_bp_file_preview)}
                            size="small"
