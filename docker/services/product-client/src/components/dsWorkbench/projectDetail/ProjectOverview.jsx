...
import DefaultProjectData from './projectOverview.json';
...
// import PDFrameworkVersions from '../../porblemDefinitionFramework/PDFrameworkVersions';
...
function ProjectOverview({ ...props }) {
    ...
    const handleSave = async () => {
        ...
        newProject.version_name = 'System Generated';
        ...
        setTimeout(() => {
            // console.log(resp)
            props.history.push(
                `/ds-workbench/project/${projectId || resp.id}/setup/problem-definition?mode='edit'`
            );
    ...
    return (
        <PDFrameworkContextProvider
            ...
            finishButtonText={projectId ? 'Save' : 'Create'}
            suppressBackground={true}
        >
            <div aria-label="Project Overview" className={classes.root}>
