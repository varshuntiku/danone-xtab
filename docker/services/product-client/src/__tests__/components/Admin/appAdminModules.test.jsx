...
import AppAdminModules from '../../../components/Admin/Modules';
        ...
        const { getByText, debug } = render(
            <CustomThemeContextProvider>
                <Router history={history}>
                    <AppAdminModules app_info={app_info} config={config} />
                </Router>
            </CustomThemeContextProvider>
        );
    });

    test('Render the layout for user guide module', () => {
        const { getByText, debug } = render(
            <CustomThemeContextProvider>
                <Router history={history}>
                    <AppAdminModules />
        ...
        const moduleHeading = screen.getByRole('heading', {
            name: 'Select Module Below'
        });
        expect(moduleHeading).toBeInTheDocument();

        const userGuideHeading = screen.getByRole('heading', {
            name: 'User Guide'
        });
        ...
        //     name: 'View Details'
        // });
        // expect(viewDetailsButton).not.toHaveLength(0);
        //fireEvent.click(viewDetailsButton[8]);

        // const disabledButton = screen.getAllByRole('button', {
        //     name: 'DISABLED'
        // });
        // expect(disabledButton).not.toHaveLength(0);
        // fireEvent.click(disabledButton[8]);
    });

    test('Render the layout for slicing filters module', () => {
        ...
        const moduleHeading = getByRole('heading', {
            name: 'Select Module Below'
        });
        expect(moduleHeading).toBeInTheDocument();

        const slicingFiltersHeading = getByRole('heading', {
            name: 'Slicing Filters'
        });
        expect(slicingFiltersHeading).toBeInTheDocument();
        ...
        // const toggleState = screen.getAllByRole('button', {
        //     name: 'ENABLED'
        // });
        // fireEvent.click(toggleState[6]);
