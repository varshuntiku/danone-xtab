...
import { render, cleanup, fireEvent, waitFor, getByPlaceholderText } from '@testing-library/react';
import { Router } from 'react-router-dom';
import { createMemoryHistory } from 'history';
import AppAdminOverview from '../../../components/Admin/Overview';
import CustomThemeContextProvider from '../../../themes/customThemeContext';
import { Provider } from 'react-redux';
import { saveAppOverview } from 'services/admin_overview.js';
...
vi.mock('services/admin_overview.js', () => ({
    saveAppOverview: vi.fn(),
    applyApplicationTheme: vi.fn()
}));
...
describe('Codex Product test', () => {
            ...
            <Provider store={store}>
                <CustomThemeContextProvider>
                    <Router history={history}>
                        <AppAdminOverview app_info={app_info} config={config} />
                    </Router>
                </CustomThemeContextProvider>
            </Provider>
        );
        //email id field's been removed from admin overview
        // fireEvent.change(screen.getByLabelText('Contact Email'), {
        //     target: { value: 'testiung the handle change' }
        // });
    });

    test('should handle additional events or side effects correctly', () => {
        const app_info = {
            id: 26,
            name: 'Integrated Demand Forecasting',
            theme: 'blue',
    ...
    test('should apply theme and check for next button', async () => {
        const app_info = {
            id: 26,
            name: 'Integrated Demand Forecasting',
            theme: 'blue',
        ...
        const themeSelector = getByRole('button', { name: 'Metadata' });
        fireEvent.click(themeSelector);
    });
    test('should handle snackbar close event', async () => {
        const app_info = {
            id: 26,
            name: 'Integrated Demand Forecasting',
            theme: 'blue',
        ...
        const themeSelector = getByRole('button', { name: 'Start' });
        fireEvent.click(themeSelector);
        expect(queryByText('Saved Successfully!')).not.toBeInTheDocument();
    });

    test('Should handle onClickOverviewNext', () => {
        const props = {
            app_info: {
                id: '1',
                name: 'Test App',
                ...
                logo_blob_name: 'logo.png',
                logo_url: 'logo_url',
                small_logo_blob_name: 'small_logo.png',
            ...
            industryData: [
                { industry_name: 'Industry1', id: '1' },
                { industry_name: 'Industry2', id: '2' }
            ],
            getIndustries: vi.fn(),
            parent_obj: {
                refreshAppSilent: vi.fn()
            }
        };
    ...
    test('Should handle onClickOverviewSave', async () => {
        saveAppOverview.mockResolvedValueOnce({ status: 'success' });
        ...
        const button = getByText('Upload Login Screen Logo');
        expect(button).toBeInTheDocument();
        fireEvent.click(button);
        expect(saveAppOverview);
    });
});
