...
import RadioButtonsGroup from '../../../../components/dynamic-form/inputFields/radiogroup';
...
describe('Codex Product test', () => {
    ...
    test('Should render layouts RadioGroup Component', () => {
        const props = {
            onChange: () => {},
            params: {
                label: 'test label',
        ...
        act(() => {
            ...
            fireEvent.change(screen.getByRole('radio'), { target: { value: false } });
        });
    });
