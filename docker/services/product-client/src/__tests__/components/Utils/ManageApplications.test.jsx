...
import ManageApplications from '../../../components/Utils/ManageApplications.jsx';
...
describe('Codex Product test', () => {
    ...
    test('Should render layouts ManageApplications Component', () => {
        ...
        const { getByText, debug } = render(
            <CustomThemeContextProvider>
                <Router history={history}>
                    <ManageApplications {...Props} />
                </Router>
            </CustomThemeContextProvider>
        );
        fireEvent.click(screen.getByTitle('Manage Application'));
        expect(screen.getByText('Edit Application')).toBeInTheDocument();
        expect(screen.getByRole('button', { name: 'Save' })).toBeInTheDocument();
        fireEvent.click(screen.getByRole('button', { name: 'Save' }));
    });

    test('Should render layouts ManageApplications Component', async () => {
        getFunctionsList.mockImplementation(({ callback }) =>
            callback([
                {
                    description: 'Underwriting & Pricing',
...
const Props = {
    ...
    application: {
        ...
        id: 10,
        industry: 'Insurance',
        logo_url: 'main_logo.png',
        name: '"At-risk" Customer Prediction',
        small_logo_url: 'small_logo.png'
    },
