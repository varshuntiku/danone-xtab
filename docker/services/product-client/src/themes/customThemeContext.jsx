...
import { getAllAppThemes } from '../services/theme';
...
function getThemeData(Themes, themeMode, themeId) {
    ...
    const themeModeData = theme?.modes.find((el) => el.mode === themeMode) || Themes[0].modes[0];
    return {
...
export default function CustomThemeContextProvider({ children }) {
    ...
    const [askedThemeId, setAskedThemeId] = useState(localStorage.getItem('codx-customer-theme'));
