...
class TextGeneration_Adapter(LLM):
    """
    Text generation API.
    ...
    def validate_environment(cls, values: Dict) -> Dict:
        ...
        try:
            ...
            values["model_url"] = values["model_kwargs"]["model_url"]
            values["client"] = TextGeneration(
                values["model_url"],
                timeout=values["timeout"],
                **values["server_kwargs"],
            )

            # values.pop('model_url')
    ...
    def _call(
        ...
        **kwargs: Any,
        ...
        try:
            invocation_params.pop("model_url")
