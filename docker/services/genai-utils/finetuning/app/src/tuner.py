...
from textcallback import GenerateTextCallback
...
def run_exp(args: Optional[Dict[str, Any]] = None, callbacks: Optional[List["TrainerCallback"]] = None):
    ...
    textcallback = GenerateTextCallback()  # type: ignore
    callbacks = [LogCallback(), textcallback] if callbacks is None else callbacks
