...
class AppSettings(BaseSettings):
    ...
    AZURE_FILE_SHARE_CONNECTION_STRING: str | None
    AZURE_FILE_SHARE_NAME: Optional[str] = "model-repository"
    ...
    FINETUNING_IMAGE_ACR_PATH: str
    FINETUNING_NAMESPACE: str
    DEPLOYMENT_IMAGE_ACR_PATH: str
    CUDA_DEPLOYMENT_IMAGE_ACR_PATH: str
    DEBUG: str | bool = False
    LLMWORKBENCH_TRAINING_POOL: Optional[str]
    LLMWORKBENCH_FINETUNE_IMAGE_URL: Optional[str]
    LLMWORKBENCH_UNTRAINED_EVALUATION_IMAGE_URL: Optional[str]
    LLMWORKBENCH_EVALUATION_IMAGE_URL: Optional[str]
    LLMWORKBENCH_DEPLOYMENT_IMAGE_URL: Optional[str]
