...
# def send_email(email_type, To=[], Subject="", Cc=[], Bcc=[], body=_body, From=None, password=None, server=smtp_server, port=smtp_port):
#     try:
...
#                     data, _subtype=image.get('file_type', None))
#                 content.add_header('Content-ID', '<%s>' %
...
#                 )
#                 payload['Content-Disposition'] = 'attachment; filename="%s"' % file.get(
#                     "file_name")
