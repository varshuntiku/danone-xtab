...
from api.db_models.projects.projects import ProblemDefinitionVersion, Project
...
@bp.route("/codex-product-api/projects/<int:project_id>/versions", methods=["GET"])
@login_required
@app_required
@projects_access_info_required
...
@bp.route("/codex-product-api/projects/<int:project_id>/versions/<string:version_id>", methods=["GET"])
@login_required
@app_required
@projects_access_info_required
...
@bp.route("/codex-product-api/projects/<int:project_id>/versions", methods=["POST"])
@login_required
@any_projects_required
@projects_access_info_required
...
@bp.route("/codex-product-api/projects/<int:project_id>/versions", methods=["PUT"])
@login_required
@any_projects_required
@projects_access_info_required
...
@bp.route("/codex-product-api/projects/<int:project_id>/versions/<string:version_id>", methods=["DELETE"])
@login_required
@any_projects_required
@projects_access_info_required
