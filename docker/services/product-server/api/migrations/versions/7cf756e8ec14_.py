...
def upgrade():
    ...
    op.add_column(
        "functions", sa.Column("parent_function_id", sa.Integer(), nullable=True)
    )
    ...
    op.add_column(
        "industry", sa.Column("parent_industry_id", sa.Integer(), nullable=True)
    )
    op.create_foreign_key(
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint(
        "industry_parent_industry_id_fkey", "industry", type_="foreignkey"
    )
    op.drop_column("industry", "parent_industry_id")
    op.drop_constraint(
        "functions_parent_function_id_fkey", "functions", type_="foreignkey"
    )
