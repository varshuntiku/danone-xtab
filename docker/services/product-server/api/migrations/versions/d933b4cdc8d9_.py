...
def downgrade():
    ...
    sa.ForeignKeyConstraint(['dashboard_id'], ['conn_system_dashboard.id'], name='business_process_dashboard_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['business_process_id'], ['business_process.id'], name='initiative_business_process_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['problem_definition_id'], ['problem_definition.id'], name='initiative_problem_definition_id_fkey'),
    ...
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    sa.Column('deleted_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('conn_system_dashboard_id_seq'::regclass)"), autoincrement=True, nullable=False),
    sa.Column('name', sa.VARCHAR(length=100), autoincrement=False, nullable=False),
    ...
    sa.ForeignKeyConstraint(['dashboard_id'], ['conn_system_dashboard.id'], name='widget_connected_system_identifier_dashboard_id_fkey'),
    ...
    op.create_table('problem_overview',
    sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
    sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    sa.Column('deleted_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
    sa.Column('id', sa.INTEGER(), autoincrement=True, nullable=False),
    ...
    sa.ForeignKeyConstraint(['problem_definition_id'], ['problem_definition.id'], name='problem_overview_problem_definition_id_fkey'),
    ...
    sa.ForeignKeyConstraint(['problem_definition_id'], ['problem_definition.id'], name='stake_holder_problem_definition_id_fkey'),
