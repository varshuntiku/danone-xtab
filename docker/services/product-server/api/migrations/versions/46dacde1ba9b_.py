...
def upgrade():
    ...
    op.create_table('nac_role_permissions',
    ...
    op.create_table('user_password_code',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table('nac_role_permissions_identifier',
    sa.Column('nac_role_id', sa.Integer(), nullable=True),
    sa.Column('nac_role_permissions_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['nac_role_id'], ['nac_roles.id'], ),
    sa.ForeignKeyConstraint(['nac_role_permissions_id'], ['nac_role_permissions.id'], )
    )
    op.create_table('nac_user_role_identifier',
    sa.Column('nac_role_id', sa.Integer(), nullable=True),
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['nac_role_id'], ['nac_roles.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], )
