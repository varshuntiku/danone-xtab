...
def upgrade():
    ...
    op.create_table('llm_cloud_provider',
    ...
    sa.ForeignKeyConstraint(['created_by'], ['user.id'], ),
    sa.ForeignKeyConstraint(['deleted_by'], ['user.id'], ),
    sa.ForeignKeyConstraint(['model_id'], ['llm_model_registry.id'], ),
    sa.ForeignKeyConstraint(['updated_by'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('llm_experiment_checkpoint',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table('llm_experiment_run_tracer',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=True),
    sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_foreign_key('llm_experiment_llm_experiment_settings_id_fkey', 'llm_experiment', 'llm_experiment_setting', ['experiment_settings_id'], ['id'])
    ...
    op.create_foreign_key('llm_experiment_result_llm_experiment_id_fkey', 'llm_experiment_result', 'llm_experiment', ['experiment_id'], ['id'])
...
def downgrade():
    ...
    op.add_column('llm_experiment_result', sa.Column('llm_experiment_id', sa.INTEGER(), autoincrement=False, nullable=True))
    op.drop_constraint('llm_experiment_result_llm_experiment_id_fkey', 'llm_experiment_result', type_='foreignkey')
    op.create_foreign_key('llm_experiment_result_llm_experiment_id_fkey', 'llm_experiment_result', 'llm_experiment', ['llm_experiment_id'], ['id'])
    op.drop_column('llm_experiment_result', 'experiment_id')
    op.add_column('llm_experiment', sa.Column('llm_experiment_settings_id', sa.INTEGER(), autoincrement=False, nullable=True))
    op.drop_constraint('llm_experiment_llm_experiment_settings_id_fkey', 'llm_experiment', type_='foreignkey')
    op.create_foreign_key('llm_experiment_llm_experiment_settings_id_fkey', 'llm_experiment', 'llm_experiment_setting', ['llm_experiment_settings_id'], ['id'])
    op.drop_column('llm_experiment', 'experiment_settings_id')
    op.add_column('llm_data_registry', sa.Column('file_location', sa.VARCHAR(length=255), autoincrement=False, nullable=True))
    ...
    op.add_column('llm_compute_config', sa.Column('disk_size', sa.VARCHAR(length=255), autoincrement=False, nullable=True))
