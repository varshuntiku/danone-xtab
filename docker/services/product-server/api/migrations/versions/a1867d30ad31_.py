...
def upgrade():
    ...
    op.create_index(
        op.f("ix_app_source_app_id"), "app", ["source_app_id"], unique=False
    )
    op.drop_constraint("app_parent_app_id_fkey", "app", type_="foreignkey")
    op.create_foreign_key(
        "app_source_app_id_fkey", "app", "app", ["source_app_id"], ["id"]
    )
    ...
    op.create_foreign_key(
        "app_container_id_fkey", "app", "app_container", ["container_id"], ["id"]
    )
...
def downgrade():
    ...
    op.create_index(
        "ix_app_parent_container_id", "app", ["parent_app_id"], unique=False
    )
