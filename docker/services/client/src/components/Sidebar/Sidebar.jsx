  ...
  render() {
    ...
    var brand = (
      <div className={logoClasses}>
        <a href="/admin/projects" className={logoMini}>
        { !this.state.miniActive ? <Logo className={classes.img}  color={'#FFA497'}/> : null}
        </a>
        <a href="/admin/projects" className={logoNormal}>
          {logoText}
        </a>
      </div>
    );
...
Sidebar.propTypes = {
  ...
  bgColor: PropTypes.oneOf(["white", "black", "blue", "codxDark"]),
