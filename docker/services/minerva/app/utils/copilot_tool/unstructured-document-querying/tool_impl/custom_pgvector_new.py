...
class PGVector(VectorStore):
    ...
    def _create_engine(self) -> sqlalchemy.engine.Engine:
        return sqlalchemy.create_engine(
            self.connection_string, connect_args={"options": "-csearch_path={}".format(self.schema_name)}
        )
    ...
    def __from(
        ...
        **kwargs: Any,
        ...
        if schema_name is None:
            schema_name = cls.get_schema_name(kwargs)
    ...
    def __query_collection(
        ...
        with Session(self._bind) as session:
            ...
            _type = self.EmbeddingStore  # noqa F841
    ...
    @classmethod
    def get_schema_name(cls, kwargs: Dict[str, Any]) -> str:
        schema_name: str = get_from_dict_or_env(
            data=kwargs,
            key="schema_name",
            env_key="PGVECTOR_SCHEMA_NAME",
        )
