...
def test_model_structure_foreign_key(db_inspector):
    ...
    expected_foreign_key = {
        "constrained_columns": ["consumer_id"],
        "referred_table": "minerva_consumer",
        "referred_columns": ["id"],
    }
    ...
    expected_foreign_key = {
        "constrained_columns": ["minerva_app_id"],
        "referred_table": "minerva_apps",
        "referred_columns": ["id"],
    }
