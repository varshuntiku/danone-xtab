...
class CommentsController(BaseController):
    async def add_comment(
        ...
        with CommentsService() as comments_service:
            new_comment_id = await comments_service.add_comment(request, request_data, background_tasks)
    ...
    async def add_reply(
        ...
        with CommentsService() as comments_service:
            new_reply_id = await comments_service.add_reply(request, user_email, request_data, background_tasks)
    ...
    def delete_state_change(self, user_id: str, comment_id: int, type: str) -> CommentAddRequestSchema:
        with CommentsService() as comments_service:
    ...
    def edit_comment(self, user_id: str, request_data: CommentEditRequestSchema) -> CommentEditResponseSchema:
        with CommentsService() as comments_service:
