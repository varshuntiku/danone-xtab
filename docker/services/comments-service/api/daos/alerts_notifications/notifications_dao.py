...
class NotificationsDao(BaseDao):
    ...
    def update_notification_read_status(self, id: int, user_email: str) -> None:
        """
            ...
            self.db_session.query(Notifications).filter(Notifications.id == id).update(
                {
                    ...
                    Notifications.updated_by: user_email,
                    Notifications.updated_at: func.now(),
                }
            )
    ...
    def get_filtered_notifications(self, identifier: str, selected_filter: Dict, logged_in_email: str):
        """
            ...
            return (
                ...
                .filter(
                    and_(
                        ...
                        Notifications.type == selected_filter["type"],
                        Notifications.is_read == selected_filter["is_read"]
                        # *notifications_filter,
                    )
                )
    ...
    def update_notification(self, id: int, user_email: str, is_read: bool) -> Dict:
        """
        ...
        try:
            ...
            notification.updated_by = user_email
    ...
    def get_notifications(self, identifier: str, logged_in_email: str) -> List[Notifications]:
        """
    ...
    def get_notifications_unread_count(self, identifier: str, logged_in_email: str) -> int:
        """
    ...
    def get_unread_notifications_by_id_order(self, identifier: str, logged_in_email: str) -> List[Notifications]:
        """
        Gets the count of unread notifications
    ...
    def notifications_greater_than_id(self, identifier: str, logged_in_email: str, last_notification_id: int):
        """
        Gets the notifications which has Id greater than the given ID
        ...
        Returns:
            Notifications with ID greater than given ID
        """
        try:
            return (
                self.db_session.query(Notifications)
    ...
    def notifications_last_id(self, identifier: str):
        """
        Gets the last_notification_id for the identifier

        Args:
            identifier : str

        Returns:
            Last notification id for the given identifier
        """
        try:
            return (
                self.db_session.query(Notifications)
    ...
    def delete_notification(self, user_email: str, request_data: DeleteMultipleNotificationsSchema):
        """
        Deletes the notifications with the user_email in the list
