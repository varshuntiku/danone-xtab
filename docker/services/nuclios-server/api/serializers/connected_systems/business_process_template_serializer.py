...
class BusinessProcessTemplateDataSerializer(BaseSerializer):
    """
    ...
    fields = ["id", "driver_id", "name", "is_active", "order_by", "process_config"]
...
class BusinessProcessTemplateListSerializer(BaseSerializer):
    """
    Serializing(JSON Formatting) and modifying data as per the requested in response.
    Applying nested serialization for packages.
    """
