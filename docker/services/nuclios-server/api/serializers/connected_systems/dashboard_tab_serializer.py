...
class DashboardTabDataSerializer(BaseSerializer):
    """
    Serializing(JSON Formatting) and modifying data as per the requested in response.
    Applying nested serialization for packages.
    """

    fields = ["id", "name", "is_active", "tab_type", "order_by", "kpis", "insights", "tools"]
...
class DashboardTabListSerializer(BaseSerializer):
    """
    Serializing(JSON Formatting) and modifying data as per the requested in response.
    Applying nested serialization for packages.
    """

    fields = ["id", "name", "is_active", "tab_type", "order_by", "created_at", "created_by_user", "updated_at"]
