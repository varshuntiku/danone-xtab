...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('comment_server_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        sa.Column(
            "created_at", DateTime, server_default=sa.text("CURRENT_TIMESTAMP"), autoincrement=False, nullable=True
        ),
        sa.Column("updated_at", DateTime, autoincrement=False, nullable=True),
        sa.Column("deleted_at", DateTime, autoincrement=False, nullable=True),
        ...
        sa.Column("bookmarked", sa.Numeric(), autoincrement=False, nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("is_read", sa.Numeric(), autoincrement=False, nullable=True),
