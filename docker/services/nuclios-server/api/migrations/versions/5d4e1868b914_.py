...
def upgrade():
    ...
    op.create_foreign_key(None, "app_screen_widget_filter_value", "app_screen", ["screen_id"], ["id"])
    ...
    op.add_column("app_screen_widget_value", sa.Column("screen_id", sa.Integer(), nullable=True))
    op.create_foreign_key(None, "app_screen_widget_value", "app_screen", ["screen_id"], ["id"])
