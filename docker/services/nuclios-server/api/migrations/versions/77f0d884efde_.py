...
def upgrade():
    ...
    op.create_index(op.f("ix_app_screen_app_id"), "app_screen", ["app_id"], unique=False)
    op.create_index(
...
def downgrade():
    ...
    op.drop_index(op.f("ix_app_screen_widget_value_app_id"), table_name="app_screen_widget_value")
    op.drop_index(
        op.f("ix_app_screen_widget_filter_value_widget_value_id"),
    ...
    op.drop_index(op.f("ix_app_screen_widget_screen_id"), table_name="app_screen_widget")
