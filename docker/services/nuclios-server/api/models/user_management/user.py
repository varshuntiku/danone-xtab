...
class User(BaseModelMixin):
    ...
    user_groups = relationship("UserGroup", secondary=user_group_identifier, back_populates="users", lazy="selectin")
    nac_user_roles = relationship("NacRoles", secondary=nac_user_role_identifier, lazy="selectin")
    ...
    def __init__(
        ...
        if default_user_data.get("user_groups"):
            self.user_groups = default_user_data.get("user_groups")

        if default_user_data.get("nac_user_roles"):
            self.nac_user_roles = default_user_data.get("nac_user_roles")
