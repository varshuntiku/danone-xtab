...
class CreateDefaultExecutionEnvironment:
    ...
    def get_default_packages(self):
        ...
        try:
            dynamic_execution_url = unquote(os.environ.get("GATEWAY_BASE_URL")) + "/nucliosdee/services/envs"
            headers = {
                "Content-Type": "application/json",
                "Authorization": f"Bearer {self.__access_token__}",
            }
    ...
    def initiate_creation_process(self):
        ...
        self.dynamic_execution_url = (
            unquote(os.environ.get("GATEWAY_BASE_URL")) + "/nucliosdee/services/dynamic-execution-environment"
        )
