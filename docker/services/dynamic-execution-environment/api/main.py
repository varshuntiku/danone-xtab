...
from api.utils.run_pending_tasks import init as run_pending_tasks
from api.utils.startup import handle_interrupted_services
...
async def lifespan(app: FastAPI):
    asyncio.create_task(run_pending_tasks())
    yield
...
# Base App
app = FastAPI(
    title="Dynamic Execution Environment Server",
    description="This is the backend for DEE",
    version="1.1.0",
