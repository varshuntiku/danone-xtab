...
from api.models import User, UserGroup, UserGroupType, db
...
@bp.route("/codex-api/user-groups", methods=["GET"])
...
@bp.route("/codex-api/user-groups", methods=["POST"])
...
@bp.route("/codex-api/user-groups/<int:user_group_id>", methods=["GET"])
...
@bp.route("/codex-api/user-groups/<int:user_group_id>", methods=["PUT", "POST"])
...
@bp.route("/codex-api/user-groups/<int:user_group_id>", methods=["DELETE"])
