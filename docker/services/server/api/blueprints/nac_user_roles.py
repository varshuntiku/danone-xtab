...
from api.models import NacRolePermissions, NacRoles, UserGroupType, db
...
@bp.route("/codex-api/nac-role-permissions", methods=["GET"])
...
@bp.route("/codex-api/nac-user-roles", methods=["GET"])
...
@bp.route("/codex-api/nac-user-roles", methods=["POST"])
...
@bp.route("/codex-api/nac-user-roles/<int:nac_user_role_id>", methods=["GET"])
...
@bp.route("/codex-api/nac-user-roles/<int:nac_role_id>", methods=["PUT", "POST"])
...
@bp.route("/codex-api/nac-user-roles/<int:nac_role_id>", methods=["DELETE"])
