...
POSTGRES_URI = "postgresql://db_user:p%40ssw0rd@codx-db-test.postgres.database.azure.com:6432/codex"
SQLALCHEMY_DATABASE_URI = "postgresql://db_user:p%40ssw0rd@codx-db-test.postgres.database.azure.com:6432/codex"
...
BACKEND_APP_URI = "https://codex-api-test.azurewebsites.net/codex-api"
BACKEND_PRODUCT_APP_URI = "https://codex-products-api-test.azurewebsites.net/codex-product-api"
BACKEND_PRODUCT_APP_SECRET = "codex-deployer-test"
...
BACKGROUND_JOBS_QUEUE = "queue-codex-test"
APPS_DB_URI = (
    "user=db_user password=p@ssw0rd host=codx-db-test.postgres.database.azure.com port=6432 dbname=codex_product"
)
...
EXECUTION_FOLDER_DATABRICKS_MOUNT = "codex_execution_test"

# specify all origins that can make requests to this backend
ALLOWED_ORIGINS = [
    "https://codex-client-test.azurewebsites.net",
    "https://codex-products-test.azurewebsites.net",
    "http://localhost:3001",
    "http://localhost:3000",
]
HTTPS_FORCE = True
